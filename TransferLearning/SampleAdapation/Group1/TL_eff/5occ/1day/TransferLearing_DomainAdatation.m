...
load([fileparts(fileparts(fileparts(pwd))) '\Data\' num2str(NumOcc_str) '\TargetDamianData_Eff.mat'])
%%
...
elseif NumOcc==15
    ...
    y_sou = discretize(y_sou, [0, 0.2, 0.4, 0.6, 0.8, 1]);
end
%%
...
if NumOcc==7
    y_tar = discretize(y_tar, [0, 0.2, 0.4, 0.6, 0.8, 1]*NumOcc);
end
...
if NumOcc==7
    ...
    x_tar=x_tar(1:60:end,:);
    y_tar=y_tar(1:60:end,:);
else
