function JSD_tar_test=TargetModelTesting(NumOcc,NumDay)
load([fileparts(fileparts(pwd)) '\Data\' num2str(NumOcc) 'occ\TargetDamianData_testing.mat'])
load([fileparts(fileparts(pwd)) '\Data\' num2str(NumOcc) 'occ\TargetDamianData_Shift.mat'])
%%
...
%%
x_train=x_feature(1:15:end,:);
y_train_array=y(1:15:end);
...
JSD_tar_test=MeanJSD(x_tar_test,y_tar_test,y_tar_test_pre);
end