...
persistent BehaviorInterval DayofYear StopTime OBM_Data
%% Extrinsic Function
...
OBM_Data_temp=[[OccupantMatrix{1, 1}.InOffice] [OccupantMatrix{1, 1}.PMVact] [OccupantMatrix{1, 1}.WhichPMVact]];
OBM_Data=[OBM_Data; OBM_Data_temp];
if clock==StopTime
    save('OBM_Data.mat','OBM_Data')
end
